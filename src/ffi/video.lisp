...
(defsdl2enum sdl-glcontext-release-flag
...
(defsdl2fun ("SDL_GL_CreateContext" sdl-gl-create-context) sdl-glcontext
  (window (:pointer sdl-window)))
...
(defsdl2fun ("SDL_GL_GetCurrentContext" sdl-gl-get-current-context) sdl-glcontext)
